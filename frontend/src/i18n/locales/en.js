export default {
  ...
  competition: {
    ...
    homeSubtitle: 'World Cup · Top 5 Leagues · Pailie 3/5',
    enter: 'Enter',
    enterDigital: 'Open games',
    statMatches: '{n} matches',
    statTeams: '{n} teams',
    statGames: '{n} games',
    statDigital: 'Daily draws',
    badgeDigital: 'Lottery',
    digitalDraw: 'Draw cycle',
    digitalDrawDaily: 'Once daily',
    statusEnded: 'Ended',
  ...
  pailie: {
    title: 'Sporttery Pailie 3 / 5',
    subtitle: 'Frequency tips · number picker · recent draws',
    refresh: 'Refresh draws',
    disclaimer: 'Rules, frequency stats and pick helpers only — not a betting service. Past frequency does not guarantee future draws.',
    pl3: 'Pailie 3',
    pl5: 'Pailie 5',
    rulesTitle: 'Rules & prizes',
    pickTitle: 'Pick numbers',
    recommendTitle: 'Recommended numbers (frequency)',
    recommendHint: 'Weighted by historical hit rate and miss gaps per position.',
